...
SYSCALL_DEFINE1(lab_lsmod_count, long *, modules_count)
{
	struct kobject *k;
	long count = 0;
...
SYSCALL_DEFINE1(lab_lsmod, struct lab_lsmod_module_info *, modules_info)
{
	struct kobject *k;

	struct lab_lsmod_module_info *cur_modules_info = modules_info;
